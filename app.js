...
['CONTRÔLE ÉLECTRIQUE',['État des câbles électriques des prises et des connecteurs',"État des équipements électriques (bloc d'alimentation, vérins …)",'Essai récurrent suivant norme NF EN 62353 (voir le rapport d’essai pour détails conformité)']]
];
...
function setScanValue(field,text,format){
  ...
  showMessage('Code détecté pour '+(FIELD_LABELS[field]||field)+' : '+el.value+' ('+format+')','success');
}
